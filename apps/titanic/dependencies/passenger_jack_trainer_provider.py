...
from apps.titanic.adapter.outbound.repositories.passenger_jack_trainer_repository import (
...
from apps.titanic.app.use_cases.passenger_jack_trainer_interactor import JackTrainerInteractor
